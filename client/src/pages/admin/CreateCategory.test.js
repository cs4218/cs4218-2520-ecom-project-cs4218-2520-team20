...
describe("CreateCategory", () => {
	...
	it("renders fetched category names", async () => {
		// Arrange + Act
		await renderCreateCategory();
	...
	it("calls create API with correct payload and shows success toast", async () => {
		// Arrange
	...
	it("re-fetches categories after successful creation", async () => {
		// Arrange
		axios.get
	...
	it("updates a category successfully via modal", async () => {
		...
		// Wait for modal to appear before interacting with it
		await screen.findByTestId("ModalMock");
		...
		// To ensure we're interacting with the correct input, check its initial value first
